		...
		<div id='main'>
			...
			<div class="container">
				...
				<div class="form-label-group" >
					<label>Pol</label>
					<br>
					<input type="radio" v-model="profile.gender" required value="Muski"> Muski
					<input type="radio" v-model="profile.gender" required value="Zenski"> Zenski
					<br>
					<br>
				</div>
        ...
        //Password check
            ...
            //Ako su uneta sva 3 passworda, nema errora za prazna polja, ali se proverava validnost samog unosa
                ...
                if (this.changedPassword.newPassword !== this.changedPassword.newPasswordRepeat) {
                    ...
                    this.profile.passwordConfirm = this.changedPassword.oldPassword;
